...
function mostraElencoCompletoLibri(): void{
    ...
    elencoLibri[i++] = new Libro("DIRITTO ED ECONOMIA", "9788823367739", "D'AMELIO MARIA GIOVANNA", "FUTURO IN TASCA (IL) - LIBRO MISTO CON LIBRO DIGITALE  CORSO DI DIRITTO ED ECONOMIA PER IL PRIMO BIENNIO - VOLUME UNICO", "U", "TRAMONTANA", "25,3", "1");
    elencoLibri[i++] = new Libro("DIRITTO ED ECONOMIA", "9788823367739", "D'AMELIO MARIA GIOVANNA", "FUTURO IN TASCA (IL) - LIBRO MISTO CON LIBRO DIGITALE  CORSO DI DIRITTO ED ECONOMIA PER IL PRIMO BIENNIO - VOLUME UNICO", "U", "TRAMONTANA", "25,3", "2");
    ...
    elencoLibri[i++] = new Libro("ELETTROTECNICA ED ELETTRONICA", "9788820378493", "CONTE GAETANO, IMPALLOMENI EMANUELE", "ELETTROTECNICA, ELETTRONICA E AUTOMAZIONE NUOVA EDIZIONE OPENSCHOOL PER IL SECONDO BIENNIO DELL'INDIRIZZO TRASPORTI E LOGISTICA", "U", "HOEPLI", "35,4", "3");
    elencoLibri[i++] = new Libro("ELETTROTECNICA ED ELETTRONICA", "9788820378493", "CONTE GAETANO, IMPALLOMENI EMANUELE", "ELETTROTECNICA, ELETTRONICA E AUTOMAZIONE NUOVA EDIZIONE OPENSCHOOL PER IL SECONDO BIENNIO DELL'INDIRIZZO TRASPORTI E LOGISTICA", "U", "HOEPLI", "35,4", "4");
    elencoLibri[i++] = new Libro("ELETTROTECNICA ED ELETTRONICA", "9788820378493", "CONTE GAETANO, IMPALLOMENI EMANUELE", "ELETTROTECNICA, ELETTRONICA E AUTOMAZIONE NUOVA EDIZIONE OPENSCHOOL PER IL SECONDO BIENNIO DELL'INDIRIZZO TRASPORTI E LOGISTICA", "U", "HOEPLI", "35,4", "5");
    ...
    elencoLibri[i++] = new Libro("INGLESE", "9788844119836", "ROBBA MARGHERITA, FAGGIANI MARIA LETIZIA", "NEW MECHWAYS - ENGLISH FOR MECHANICS, MECHATRONICS AND ENERGY", "U", "EDISCO", "25,8", "3");
    elencoLibri[i++] = new Libro("INGLESE", "9788844119836", "ROBBA MARGHERITA, FAGGIANI MARIA LETIZIA", "NEW MECHWAYS - ENGLISH FOR MECHANICS, MECHATRONICS AND ENERGY", "U", "EDISCO", "25,8", "4");
    elencoLibri[i++] = new Libro("INGLESE", "9788844119836", "ROBBA MARGHERITA, FAGGIANI MARIA LETIZIA", "NEW MECHWAYS - ENGLISH FOR MECHANICS, MECHATRONICS AND ENERGY", "U", "EDISCO", "25,8", "5");
    elencoLibri[i++] = new Libro("INGLESE", "9788861618176", "SBOLOGNINI, B C BARBER, KO'MALLEY", "CAREER PATHS IN TECHNOLOGY ELECTRICITY AND ELECTRONICSÂ INFORMATION TECHNOLOGY AND TELECOMMUNICATIONS", "U", "LANG EDIZIONI", "27,7", "3");
    elencoLibri[i++] = new Libro("INGLESE", "9788861618176", "SBOLOGNINI, B C BARBER, KO'MALLEY", "CAREER PATHS IN TECHNOLOGY ELECTRICITY AND ELECTRONICSÂ INFORMATION TECHNOLOGY AND TELECOMMUNICATIONS", "U", "LANG EDIZIONI", "27,7", "4");
    elencoLibri[i++] = new Libro("INGLESE", "9788861618176", "SBOLOGNINI, B C BARBER, KO'MALLEY", "CAREER PATHS IN TECHNOLOGY ELECTRICITY AND ELECTRONICSÂ INFORMATION TECHNOLOGY AND TELECOMMUNICATIONS", "U", "LANG EDIZIONI", "27,7", "5");
    elencoLibri[i++] = new Libro("INGLESE", "9788861618176", "SBOLOGNINI, B C BARBER, KO'MALLEY", "CAREER PATHS IN TECHNOLOGY ELECTRICITY AND ELECTRONICSÂ INFORMATION TECHNOLOGY AND TELECOMMUNICATIONS", "U", "LANG EDIZIONI", "27,7", "4");
    elencoLibri[i++] = new Libro("INGLESE", "9788861618176", "SBOLOGNINI, B C BARBER, KO'MALLEY", "CAREER PATHS IN TECHNOLOGY ELECTRICITY AND ELECTRONICSÂ INFORMATION TECHNOLOGY AND TELECOMMUNICATIONS", "U", "LANG EDIZIONI", "27,7", "5");
    elencoLibri[i++] = new Libro("INGLESE", "9788883394485", "AA VV", "MY VOICE A2/B1", "U", "PEARSON LONGMAN", "29,9", "1");
    elencoLibri[i++] = new Libro("INGLESE", "9788883394485", "AA VV", "MY VOICE A2/B1", "U", "PEARSON LONGMAN", "29,9", "2");
    elencoLibri[i++] = new Libro("INGLESE", "9788883394492", "AA VV", "MY VOICE B1/B1+", "U", "PEARSON LONGMAN", "29,9", "2");
    elencoLibri[i++] = new Libro("INGLESE", "9788883395994", "AA VV", "MY VOICE B2", "U", "PEARSON LONGMAN", "33,9", "3");
    elencoLibri[i++] = new Libro("INGLESE", "9788883395994", "AA VV", "MY VOICE B2", "U", "PEARSON LONGMAN", "33,9", "4");
    elencoLibri[i++] = new Libro("INGLESE", "9788883395994", "AA VV", "MY VOICE B2", "U", "PEARSON LONGMAN", "33,9", "5");
    elencoLibri[i++] = new Libro("INGLESE", "9788899673154", "GUALANDRI, CANELLINI", "ALL ABOUT LOGISTICS PLUS + CD AUDIO 50241  STORAGE & DELIVERY", "U", "TRINITY WHITEBRIDGE", "18,5", "3");
    elencoLibri[i++] = new Libro("INGLESE", "9788899673154", "GUALANDRI, CANELLINI", "ALL ABOUT LOGISTICS PLUS + CD AUDIO 50241  STORAGE & DELIVERY", "U", "TRINITY WHITEBRIDGE", "18,5", "4");
    elencoLibri[i++] = new Libro("INGLESE", "9788899673154", "GUALANDRI, CANELLINI", "ALL ABOUT LOGISTICS PLUS + CD AUDIO 50241  STORAGE & DELIVERY", "U", "TRINITY WHITEBRIDGE", "18,5", "5");
    ...
    elencoLibri[i++] = new Libro("ITALIANO GRAMMATICA", "9791254550106", "SAVIGLIANO C", "GRAMMATUTOR - PER PARLARE E SCRIVERE BENE  VOLUME BASE + LABORATORIO DELLE COMPETENZE + EBOOK", "U", "GARZANTI SCUOLA", "28,1", "1");
    elencoLibri[i++] = new Libro("ITALIANO GRAMMATICA", "9791254550106", "SAVIGLIANO C", "GRAMMATUTOR - PER PARLARE E SCRIVERE BENE  VOLUME BASE + LABORATORIO DELLE COMPETENZE + EBOOK", "U", "GARZANTI SCUOLA", "28,1", "2");
    ...
    elencoLibri[i++] = new Libro("LOGISTICA", "9788836012275", "DALLARI FABRIZIO, COSSU ELENA", "CORSO DI LOGISTICA E TRASPORTI  ORGANIZZAZIONE E GESTIONE DELLA SUPPLY CHAIN E DELLA SICUREZZA", "2", "HOEPLI", "32,9", "4");
    elencoLibri[i++] = new Libro("LOGISTICA", "9788836012275", "DALLARI FABRIZIO, COSSU ELENA", "CORSO DI LOGISTICA E TRASPORTI  ORGANIZZAZIONE E GESTIONE DELLA SUPPLY CHAIN E DELLA SICUREZZA", "2", "HOEPLI", "32,9", "5");
    ...
    elencoLibri[i++] = new Libro("MECCANICA", "9788820383329", "AA VV", "MANUALE DEL MANUTENTORE", "U", "HOEPLI", "76,9", "3");
    elencoLibri[i++] = new Libro("MECCANICA", "9788820383329", "AA VV", "MANUALE DEL MANUTENTORE", "U", "HOEPLI", "76,9", "4");
    elencoLibri[i++] = new Libro("MECCANICA", "9788820383329", "AA VV", "MANUALE DEL MANUTENTORE", "U", "HOEPLI", "76,9", "5");
    elencoLibri[i++] = new Libro("RELIGIONE", "9788839303394", "CERA T, FAMA' A", "STRADA CON L'ALTRO (LA) - VOLUME UNICO LEZIONI E PERCORSI + EBOOK", "U", "MARIETTI SCUOLA", "19,35", "3");
    elencoLibri[i++] = new Libro("RELIGIONE", "9788839303394", "CERA T, FAMA' A", "STRADA CON L'ALTRO (LA) - VOLUME UNICO LEZIONI E PERCORSI + EBOOK", "U", "MARIETTI SCUOLA", "19,35", "4");
    elencoLibri[i++] = new Libro("RELIGIONE", "9788839303394", "CERA T, FAMA' A", "STRADA CON L'ALTRO (LA) - VOLUME UNICO LEZIONI E PERCORSI + EBOOK", "U", "MARIETTI SCUOLA", "19,35", "5");
    elencoLibri[i++] = new Libro("RELIGIONE", "9788839303943", "CERA T, FAMA A, SORICE O", "STRADA CON L'ALTRO - EDIZIONE VERDE (LA)  VOLUME UNICO + UDA MULTIDISCIPLINARI DI EDUCAZIONE CIVICA E IRC + EBOOK", "U", "MARIETTI SCUOLA", "18,75", "1");
    elencoLibri[i++] = new Libro("RELIGIONE", "9788839303943", "CERA T, FAMA A, SORICE O", "STRADA CON L'ALTRO - EDIZIONE VERDE (LA)  VOLUME UNICO + UDA MULTIDISCIPLINARI DI EDUCAZIONE CIVICA E IRC + EBOOK", "U", "MARIETTI SCUOLA", "18,75", "2");
    ...
    elencoLibri[i++] = new Libro("SCIENZE INTEGRATE (CHIMICA)", "9788823365957", "CORDIOLI DORIANO", "CHIMICA PRATICA - LIBRO MISTO CON LIBRO DIGITALE  VOLUME UNICO PER IL BIENNIO", "U", "TRAMONTANA", "36,9", "1");
    elencoLibri[i++] = new Libro("SCIENZE INTEGRATE (CHIMICA)", "9788823365957", "CORDIOLI DORIANO", "CHIMICA PRATICA - LIBRO MISTO CON LIBRO DIGITALE  VOLUME UNICO PER IL BIENNIO", "U", "TRAMONTANA", "36,9", "2");
    elencoLibri[i++] = new Libro("SCIENZE INTEGRATE (FISICA)", "9788863648850", "WALKER", "FISICA DI WALKER (LA) - VOLUME UNICO", "U", "LINX", "39,1", "1");
    elencoLibri[i++] = new Libro("SCIENZE INTEGRATE (FISICA)", "9788863648850", "WALKER", "FISICA DI WALKER (LA) - VOLUME UNICO", "U", "LINX", "39,1", "2");
    ...
    elencoLibri[i++] = new Libro("STORIA", "9788835055204", "GENTILE, RONGA, ROSSI", "FUCINA DI VULCANO - VOLUME 1 (LA)  CORSO DI STORIA ED EDUCAZ.CIVICA", "1", "LA SCUOLA EDITRICE", "25,1", "1");
    elencoLibri[i++] = new Libro("STORIA", "9788835055204", "GENTILE, RONGA, ROSSI", "FUCINA DI VULCANO - VOLUME 1 (LA)  CORSO DI STORIA ED EDUCAZ.CIVICA", "1", "LA SCUOLA EDITRICE", "25,1", "2");
    ...
    elencoLibri[i++] = new Libro("STRUTTURA, COSTRUZIONE, SISTEMI E IMPIANTI", "9788884883148", "AA VV", "TECNICA DELL'AUTOMOBILE MANUALE DI TECNOLOGIA DEI VEICOLI A MOTORE", "U", "SAN MARCO", "42", "3");
    elencoLibri[i++] = new Libro("STRUTTURA, COSTRUZIONE, SISTEMI E IMPIANTI", "9788884883148", "AA VV", "TECNICA DELL'AUTOMOBILE MANUALE DI TECNOLOGIA DEI VEICOLI A MOTORE", "U", "SAN MARCO", "42", "4");
    elencoLibri[i++] = new Libro("STRUTTURA, COSTRUZIONE, SISTEMI E IMPIANTI", "9788884883148", "AA VV", "TECNICA DELL'AUTOMOBILE MANUALE DI TECNOLOGIA DEI VEICOLI A MOTORE", "U", "SAN MARCO", "42", "5");
    ...
    elencoLibri[i++] = new Libro("TECNOLOGIE E TECNICHE DI RAPPRESENT.GRAFICA", "9788841651780", "ZANIN ALBINO, BALDISSERI GIORGIO", "TECNOGRAFICA + DISEGNO + TECNOLOGIA", "U", "PRINCIPATO", "27,9", "1");
    elencoLibri[i++] = new Libro("TECNOLOGIE E TECNICHE DI RAPPRESENT.GRAFICA", "9788841651780", "ZANIN ALBINO, BALDISSERI GIORGIO", "TECNOGRAFICA + DISEGNO + TECNOLOGIA", "U", "PRINCIPATO", "27,9", "2");
