...
function apriDatabase() {
    var out = new Promise(function (resolve, reject) {
        var richiestaDB = indexedDB.open("Database", 1);
        //cosa fare in caso di errore
        richiestaDB.onerror = function () {
            // restituisco motivo errore
            reject(richiestaDB.onerror);
        };
        // richiesta accolta
        richiestaDB.onsuccess = function () {
            var database = richiestaDB.result;
            resolve(database);
        };
        //database aggiornato o creato per la prima volta
        richiestaDB.onupgradeneeded = function () {
            var database = richiestaDB.result;
            ...
            if (!database.objectStoreNames.contains("Copie")) {
                ...
                var tabellaCopie = database.createObjectStore("Copie", {
...
document.addEventListener("DOMContentLoaded", function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                err_1 = _a.sent();
                console.error("Errore apertura DB:", err_1);
                return [3 /*break*/, 3];
